...
// Function to adjust the map height dynamically based on the device's screen height
function adjustMapHeight() {
    // Get the viewport height dynamically
    var viewportHeight = window.innerHeight;

    // Set the iframe's height to the viewport height
    document.getElementById('map').style.height = viewportHeight + 'px';
}

// Adjust the map height on window resize or load
